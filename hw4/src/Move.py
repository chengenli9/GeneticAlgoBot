...
class Move(object):
    ...
    def __init__(self, inputMoveType, inputCoordList = None, inputBuildType = None):
        self.moveType = inputMoveType # List of moves: move ant, build, end turn
        self.coordList = inputCoordList # List of tuples [(x, y)]
        self.buildType = inputBuildType # What are you building
